...
const HowToPlaySection: React.FC = (
  {steps, title}: {steps: [object], title: string}
) => {
  return (
    <div className="wrap">
  ...
  return (
    <div className="wrap">
      <div className="content">
        ...
        <HowToPlaySection title="Join or Create a game in the Lobby" steps={steps_lobby} />
        <HowToPlaySection title="Gameplay: Encryptor (clue giver)" steps={steps_encryptor} />
        <HowToPlaySection title="Gameplay: Decryptors (clue guessers)" steps={steps_decryptors} />
        <HowToPlaySection title="Gameplay: Scoring / Winning" steps={steps_winning} />
      </div>
    </div>
  );
};
